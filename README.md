...
```
curl -L https://raw.githubusercontent.com/rogellevi/badvpn-pro/main/badvpn-pro.sh -o badvpn-pro.sh && chmod +x badvpn-pro.sh && sudo ./badvpn-pro.sh
...
Dashboard web en: http://<IP_DEL_SERVIDOR>:8080
